...
<body>
    <div id="doc" class="markdown-body container-fluid"><h3 id="ssh-to-the-ec2-instance" style=""><a class="anchor hidden-xs" href="#ssh-to-the-ec2-instance" title="ssh-to-the-ec2-instance"><span class="octicon octicon-link"></span></a>SSH to the EC2 instance</h3><p>Dans un terminal sur votre ordinateur (changer <em>MY-Public-DNS-(IPv4)</em>):</p><pre><code>ssh ec2-user@MY-Public-DNS-(IPv4)
