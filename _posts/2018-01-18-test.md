...
<head>
    ...
    <title>
        Launch mongoDB on EC2 instance - HackMD
    </title>
...
<body>
    <div id="doc" class="markdown-body container-fluid"><h1 id="launch-mongodb-on-ec2-instance" style=""><a class="anchor hidden-xs" href="#launch-mongodb-on-ec2-instance" title="launch-mongodb-on-ec2-instance"><span class="octicon octicon-link"></span></a>Launch mongoDB on EC2 instance</h1><p><em>Yrieix Leprince</em> – 18/01/2018</p><h3 id="ssh-to-the-ec2-instance" style=""><a class="anchor hidden-xs" href="#ssh-to-the-ec2-instance" title="ssh-to-the-ec2-instance"><span class="octicon octicon-link"></span></a>SSH to the EC2 instance</h3><p>Dans un terminal sur votre ordinateur (changer <em>MY-Public-DNS-(IPv4)</em>):</p><pre><code>ssh ec2-user@MY-Public-DNS-(IPv4)
</code></pre><h3 id="mongodb-installation" style=""><a class="anchor hidden-xs" href="#mongodb-installation" title="mongodb-installation"><span class="octicon octicon-link"></span></a>MongoDB installation</h3><p><a href="https://docs.mongodb.com/manual/tutorial/install-mongodb-on-amazon/" target="_blank">https://docs.mongodb.com/manual/tutorial/install-mongodb-on-amazon/</a></p><p>1° Une fois connecté à l’EC2:</p><pre><code>sudo vi /etc/yum.repos.d/mongodb-org-3.6.repo
</code></pre><p>Puis copier-coller le texte suivant:</p><pre><code>[mongodb-org-3.6]
name=MongoDB Repository
baseurl=https://repo.mongodb.org/yum/amazon/2013.03/mongodb-org/3.6/x86_64/
gpgcheck=1
enabled=1
gpgkey=https://www.mongodb.org/static/pgp/server-3.6.asc
</code></pre><p>2° On peut maintenant <strong>installer</strong> mongodb:</p><pre><code>sudo yum install -y mongodb-org
</code></pre><p>3° On peut maintenant <strong>lancer</strong> mongod:</p><pre><code>sudo service mongod start
</code></pre><p>Il est possible de consulter le log de lancement avec la commande:<br>
<code>sudo cat /var/log/mongodb/mongod.log</code></p><p>4° On peut <strong>quitter</strong> ou <strong>restart</strong> mongod:</p><pre><code>sudo service mongod stop
sudo service mongod restart
</code></pre><h3 id="python-3-installation" style=""><a class="anchor hidden-xs" href="#python-3-installation" title="python-3-installation"><span class="octicon octicon-link"></span></a>Python 3 installation</h3><h4 id="install-python" style=""><a class="anchor hidden-xs" href="#install-python" title="install-python"><span class="octicon octicon-link"></span></a>Install Python</h4><p>Pour avoir la liste des <strong>Python3</strong> disponibles:</p><pre><code>sudo yum list | grep python3
</code></pre><p>Dans notre cas on choisit <strong>Python 3.6</strong>:</p><pre><code>sudo yum install python36
</code></pre><p>Pour vérifier: <code>python36 --version</code></p><h4 id="packages-installation-pandas-twisted-pymongo…" style=""><a class="anchor hidden-xs" href="#packages-installation-pandas-twisted-pymongo…" title="packages-installation-pandas-twisted-pymongo…"><span class="octicon octicon-link"></span></a>Packages installation: Pandas, Twisted, Pymongo…</h4><pre><code>sudo python36 -m pip install pandas
...
</code></pre><p>Pour <strong>Twisted</strong> (nécessite d’installer un compiler):</p><pre><code>sudo yum install -y python36-devel.x86_64
    ...
    <div class="ui-toc dropup unselectable hidden-print" style="display:none;">
        <div class="pull-right dropdown">
            ...
            <ul id="ui-toc" class="ui-toc-dropdown dropdown-menu" aria-labelledby="tocLabel">
                <div class="toc"><ul class="nav"><li class=""><a href="#launch-mongodb-on-ec2-instance">Launch mongoDB on EC2 instance</a><ul class="nav"><li><a href="#ssh-to-the-ec2-instance">SSH to the EC2 instance</a></li><li><a href="#mongodb-installation">MongoDB installation</a></li><li><a href="#python-3-installation">Python 3 installation</a><ul class="nav"><li><a href="#install-python">Install Python</a></li><li><a href="#packages-installation-pandas-twisted-pymongo…">Packages installation: Pandas, Twisted, Pymongo…</a></li></ul></li></ul></li></ul></div><div class="toc-menu"><a class="expand-toggle" href="#">Expand all</a><a class="back-to-top" href="#">Back to top</a><a class="go-to-bottom" href="#">Go to bottom</a></div>
            </ul>
        </div>
    </div>
